...
fn main() {
    ...
    println!("Check forward diagonal");
    for r in line_size..row_size {
        for c in 0..(col_size-line_size) {
            let mut product = 1;
    ...
    println!("Max product is {}", max_product);
}
